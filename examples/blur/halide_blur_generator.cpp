...
public:
    ...
    void generate() {
        ...
        if (get_target().has_gpu_feature()) {
            ...
            printf("\n\n*********** CPU schedule ***************\n\n");
        #if 1
            blur_y.split(y, y, yi, 32).parallel(y).vectorize(x, 128);
